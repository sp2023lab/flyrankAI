...
class Settings(BaseSettings):
    ...
    ai_job_retry_backoff_seconds: int = Field(default=5, ge=0, le=300)
    ai_job_stale_after_seconds: int = Field(default=300, ge=30, le=3600)
    ai_failure_webhook_url: str | None = None
    ai_failure_alert_timeout_seconds: float = Field(default=5.0, gt=0, le=30)
